...
def zero_mining_payload(reason: str | None = None) -> dict[str, Any]:
    return {
        ...
        "hashrate_hs": 0.0,
        "temperature_c": None,
        "asic_frequency_mhz": 0.0,
        "asic_frequency_target_mhz": 0.0,
        "difficulty": 0.0,
        "valid_shares": 0,
        "invalid_shares": 0,
        "accepted": 0,
...
def fetch_mining_metrics(timeout_override: float | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "asic_frequency_mhz": _num(data.get("asic_frequency_mhz")),
        "asic_frequency_target_mhz": _num(data.get("asic_frequency_target_mhz")),
